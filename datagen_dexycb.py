...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/cluster/scratch/rrajaraman/data/dex-january-2025/neus_nsubsample-3', help='path to the video')
    parser.add_argument('--vid_name', type=str, default='subject-01', help='path to the video')
    # set the gpu
    ...
    parser.add_argument('--outdir', type=str, default='./dex_traj', help='output directory')
    # set the fps
    ...
    for idx in tqdm(range(num_cams)):
        # read the camera
        depth, imgs, intrinsics, extrinsics, cam_ID = read_cam_dex(sequence_path, idx)
